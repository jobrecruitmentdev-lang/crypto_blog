...
import type { Airdrop, BlogPost, Category, Faq, Guide, TickerItem } from "./types";
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    tag: "Guide",
    title: "How to Farm Airdrops Safely in 2026",
    excerpt: "A practical checklist for wallet hygiene, sybil avoidance and snapshot timing.",
    date: "Jul 14, 2026",
    read: "6 min",
  ...
  },
  {
    ...
    tag: "News",
    title: "Layer 2 Season: Which Chains Are Rewarding Early Users",
    excerpt: "Comparing incentive programs across the top rollups this quarter.",
    date: "Jul 10, 2026",
    read: "4 min",
  ...
  },
  {
    ...
    tag: "Guide",
    title: "Retroactive Airdrops Explained",
    excerpt: "Why protocols reward historical usage and how to position for it.",
    date: "Jul 5, 2026",
    read: "5 min",
...
export const GUIDES: Guide[] = [
  {
    ...
    title: "Setting Up a Farming Wallet",
    level: "Beginner",
    desc: "Create and secure a dedicated wallet for airdrop farming, separate from your main holdings.",
  ...
  },
  {
    ...
    title: "Bridging to Layer 2 Networks",
    level: "Beginner",
    desc: "A walkthrough of bridging ETH and stablecoins to popular rollups.",
  ...
  },
  {
    ...
    title: "Understanding Snapshot Mechanics",
    level: "Intermediate",
    desc: "How token snapshots work and what activity typically counts.",
  ...
  },
  {
    ...
    title: "Avoiding Sybil Detection",
    level: "Advanced",
    desc: "Best practices for wallet behavior that reduce the risk of being flagged.",
